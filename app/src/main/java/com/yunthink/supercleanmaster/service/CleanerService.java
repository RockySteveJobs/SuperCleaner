...
public class CleanerService extends Service {
    ...
    private List<CacheListItem> datas;
    ...
    private class TaskScan extends AsyncTask<Void, Integer, List<CacheListItem>> {
        ...
        protected void onProgressUpdate(Integer... values) {
            if (mOnActionListener != null) {
                mOnActionListener.onScanProgressUpdated(CleanerService.this, values[0], values[1],mCacheSize);
            }
        }
...
//                mOnActionListener.onScanCompleted(CleanerService.this, datas);
            }
